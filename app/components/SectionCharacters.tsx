  ...
  return (
    <>
      <div
        ...
        className="w-screen flex-col justify-center pb-10 pt-56 xl:flex xl:flex-row"
      >
          ...
          <div className="w-[90%] h-28 flex-col justify-center border-[1px] border-slate-200 dark:border-none bg-white dark:bg-zinc-900 rounded-md sm:flex sm:flex-row items-center">
            <div className="w-[100%] flex justify-center items-center">
              <h1
                ...
                className="hidden text-zinc-800 text-opacity-80 dark:text-white text-md dark:opacity-50 font-black cursor-pointer transition-colors hover:text-opacity-70  dark:hover:text-opacity-70 pb-4 sm:text-2xl sm:pb-0 md:text-3xl sm:flex"
              >
                CHARACTERS
              </h1>
            </div>
            <div className="w-[100%] mt-6 flex flex-col justify-end items-center gap-2 sm:mt-0">
              ...
              >
                <input
                  data-testid="Input"
                  className="w-48 h-8 rounded-l-md bg-zinc-200 dark:bg-zinc-800 focus:outline-none text-zinc-800 text-center focus:animate-pulse dark:text-white font-bold text-lg tracking-wider"
                />
                <div
                  data-testid="trigger"
